...
## 📋 User will need Admin Rights - To allow only the printers the users have access to show. The Basic version (https://github.com/SLCGit1/NetworkPrinterBasic) of the script will show all printers on SMB so the user can choose, No admin right are need for this.
